...
const POSITIONS = [
  ...
  },
  {
    ...
    description:
      "The Club Coordinator leads the club's operations, ensuring smooth execution of projects, events, and competitions. The Co-Coordinator assists in managing responsibilities, fostering collaboration, and maintaining organizational efficiency.",
  ...
  },
  {
    ...
    label: "Project Lead",
    description:
      "Leads the project efforts, managing tasks and ensuring project goals are met efficiently.",
  ...
  },
  {
    ...
    description:
      "Assists the Project Lead in managing the project and overseeing team activities.",
  ...
  },
  {
    ...
    description:
      "Handles the design and development of key components of the project.",
  ...
  },
  {
    ...
    label: "Web Dev",
    description:
      "Manages the club's online presence, including the website and digital tools.",
...

  {
    ...
    description:
      "Manages the club's branding, design, and social media outreach.",
...
const SECTION_DURATIONS = [
  ...
  10000, // Project Lead
  15000, // Project Co-Lead
  30000, // Technical Team
  30000, // Web Dev
  15000, // Design and Social Media
];
...
const SAETeam: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(() => {
      setCurrentSectionIndex((prev) => (prev + 1) % POSITIONS.length);
    }, SECTION_DURATIONS[currentSectionIndex] || 6000);

    return () => clearTimeout(timeout);
  }, [isAuthenticated, currentSectionIndex]);
  ...
  return (
    <div className="relative">
                          ...
                          <div>
                            ...
                            {isAuthenticated && (
                              <div className="flex justify-center gap-2 mt-2">
                                ...
                                <button
                                  onClick={() =>
                                    handleDelete(member.id, member.Image)
                                  }
      ...
      {isAuthenticated && (
        <div
          className={`${styles.container} fixed bottom-4 left-1/2 transform -translate-x-1/2`}
        >
